...
function EntertainmentCard(props) {
  return (
    <>
      <div className="h-30 px-4 bg-background-white">
        <img
...
export default function EntertainmentCardSlider() {
  ...
  return (
    <>
    <div  className="px-20 pt-10 pb-2 md:px-5 sm:px-4 bg-background-white" >
      <h1
    className="font-bold text-3xl sm:text-lg">The Best Of Entertainment</h1>
      <Slider {...settings} className=" bg-background-white">
